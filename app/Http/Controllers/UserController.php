...
class UserController extends Controller
{
    ...
    public function storeAvatar(Request $request)
    {
        ...
        if ($oldAvatar != "/fallback-avatar.jpg") {
                Storage::delete(str_replace("/storage/", "public/", $oldAvatar));
                    ...
                    return back()->with('success', 'Congrats you account has been edited!.');
        }
    ...
    private function getSharedData($user)
    {
        ...
        View::share('sharedData', [
            ...
            'postCount' => $user->posts()->count(), 'followerCount' => $user->followers()->count(), 'followingCount' => $user->followingTheseUsers()->count()
        ]);
    }
    ...
    public function login(Request $request)
    {
        ...
        if (auth()->attempt(['username' => $incomingFields['loginusername'], 'password' => $incomingFields['loginpassword']])) {
            ...
            return redirect('/')->with('error', 'Invalide login.');
        }
    }
